      ...
      <div className=" md:w-1/2  rounded-lg">
        ...
        >
          <button className="relative flex flex-col justify-center items-center border-2 p-3 gap-2 bg-custom_bluelight rounded-lg md:h-full">
            ...
            />
            <img src={front[0].img} className="w-2/5" />
            <h1 className="text-sm">{front[0].title}</h1>
          </button>
          <button className=" relative flex flex-col justify-center items-center border-2 p-3 gap-2  bg-custom_bluelight rounded-lg md:h-full">
            <input
              type="checkbox"
              className="absolute top-2 right-2  z-100 opacity-50"
            />
            <img src={front[1].img} className="w-2/5 " />
            <h1 className="text-sm">{front[1].title}</h1>
          </button>
          <button className="relative flex flex-col justify-center items-center border-2 p-3 gap-2  bg-custom_bluelight rounded-lg md:h-full">
            <input
              type="checkbox"
              className="absolute top-2 right-2  z-100 opacity-50"
            />
            <img src={front[2].img} className="w-2/5" />
            <h1 className="text-sm">{front[2].title}</h1>
          </button>
          <button className="relative flex flex-col justify-center items-center border-2 p-3 gap-2  bg-custom_bluelight rounded-lg md:h-full">
            <input
              type="checkbox"
              className="absolute top-2 right-2  z-100 opacity-50"
            />
            <img src={front[3].img} className="w-2/5" />
            <h1 className="text-sm">{front[3].title}</h1>
          </button>
          <button className="relative flex flex-col justify-center items-center border-2 p-3 gap-2  bg-custom_bluelight rounded-lg md:h-full">
            <input
              type="checkbox"
              className="absolute top-2 right-2  z-100 opacity-50"
            />
            <img src={front[4].img} className="w-2/5" />
            <h1 className="text-sm">{front[4].title}</h1>
          </button>
        </div>
      </div>
